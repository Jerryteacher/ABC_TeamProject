...
public class Quest_LevelUp : Quest
{
    ...
    {
        base.progress = GameManager.instance.playerManager.playerStats.Level + " / " + targetLevel;
    }
    ...
    public override void SetQuestEvent()
    {
        ...
        if (GameManager.instance.playerManager.playerStats.Level >= targetLevel)
        {
    ...
    // 퀘스트 진행
    public void QuestProgress(PlayerStats playerStats)
    {
        // 퀘스트 진행 중일 때만
        ...
        int curr_Level = playerStats.Level;
