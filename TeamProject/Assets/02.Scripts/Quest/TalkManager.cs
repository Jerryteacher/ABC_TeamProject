...
public class TalkManager : MonoBehaviour
{
    ...
    {
        talkData.Add(1000, new string[] { "안녕?:0", "이 곳이 처음?:0" }); //데이터 옆에 : + 숫자 를 사용하면 기호+ index값의 초상화 스프라이트가 가져와짐.
                                                                    //string을 배열로 넣은 이유 = 문장을 여러개 넣기 위해서.
        talkData.Add(2000, new string[] { "서민구!!!:0", "바보:0" });
        talkData.Add(3000, new string[] { "굴러라~:0", "서민구!:0" });
        talkData.Add(100, new string[] {"이것은 빈 오브젝트다." });
        talkData.Add(200, new string[] { "이것은 큐브다." });
        ...
        talkData.Add(21 + 3000, new string[] {"귀중한 물건이었는데 찾아줘서 정말 고마워:0"});
