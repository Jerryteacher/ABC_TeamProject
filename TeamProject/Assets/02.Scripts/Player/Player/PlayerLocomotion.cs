...
namespace SG
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        public GameObject nomalCamera;

        [Header("Ground & Air Detection Stats")]
        [SerializeField] float groundDetectionRayStartPoint = 0.5f;
        [SerializeField] float minumumDistanceNeededToBeginFall = 1f;
        ...
        public void HandleRollingAndSprinting(float delta) //구르기, 달리기
        {
            ...
            if (inputHandler.rollFlag)
            {
                ...
                {
                    animatorHandler.PlayTargetAnimation("Run Backwards", true);
                }
            }
        }
        ...
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            Debug.DrawRay(origin, -Vector3.up * minumumDistanceNeededToBeginFall, Color.red, 0.1f, false);
            if (Physics.Raycast(origin, -Vector3.up, out hit, minumumDistanceNeededToBeginFall, ignoreForGroundCheck))
            {
